...
describe( 'User Model Unit Tests:', function () {
  ...
  describe( 'User Password Validation Tests', function () {
    ...
    it( 'Não deve permitir uma senha maior do que 128 digitos.', function ( done ) {
      var _user1 = new User( user1 );
      _user1.password = ')!/uLT="lh&:`6X!]|15o!$!TJf,.13l?vG].-j],lFPe2/QhwN#{Z<[*1nX@n1^?WW-%_.*D)m$toB+N7z}kcN#B_d(f41h%w@0F!]igtSQ1gl~6sEV&r~}~1ub>If1c+';
    ...
    it( 'The password must contain at least one uppercase letter. - "p@$$w0rd!!"', function ( done ) {
      var _user1 = new User( user1 );
      _user1.password = 'p@$$w0rd!!';
