...
module.exports = function (grunt) {
  ...
  grunt.task.registerTask('mongoose', 'Conecta ao MongoDB e carrega os modelos de aplicações.', function () {
    // Get the callback
    var done = this.async();
  ...
  grunt.task.registerTask('dropdb', 'remove o banco de dados usado em testes', function () {
    // async mode
    var done = this.async();
  ...
  grunt.task.registerTask('server', 'Iniciando o servidor', function () {
    // Get the callback
    var done = this.async();
